...
try {
  ...
  setUpdatingId(null);
    ...
    return (<div className="px-4 py-5 space-y-5"> <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 rounded-2xl p-5"> <div className="flex items-center gap-3"> <div className="w-11 h-11 rounded-xl bg-orange-600 flex items-center justify-center"> <ClipboardList className="w-6 h-6 text-white" /> </div>
                        ...
                        <div>
                            {proximoStatus && proximoStatusInfo ? (
                                <button
                                    ...
                                    onClick={() =>
                                        handleStatusChange(pedido.id, proximoStatus)
                                    }
